...
public struct VerticalValuesTrack<V, TrackShape: InsettableShape>: View where V : BinaryFloatingPoint {
...
extension VerticalValuesTrack where TrackShape == Capsule {
...
public extension VerticalValuesTrack {
